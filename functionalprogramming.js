...
// consoleStyler('pink', 'black', '24px', 'eloiji');
...
// styleAndCelebrate('cyan', 'orange', '56px', 'HOORAY!', 'birthday');
styleAndCelebrate('#ef7c8e', '#fae8e0', '30px', 'You made it!', 'champions');


// function consoleStyler(color, background, fontSize, txt) {
//     var myMessage = `%c${txt}`;
//     var myStyle = `color:${color}; background: ${background}; font-size:${fontSize};`;
    
//     console.log(myMessage, myStyle);
// }
